...
client.on('message', msg => {
    ...
    else if (msg.content.startsWith(process.env.PREFIX))
    {
        ...
        if (ms.includes('זדיין'))
        {
            ...
            || ms.includes('ביסקוויט')|| ms.includes('נייגר')|| ms.includes('נגר')|| ms.includes('toxic')|| ms.includes('טוקסיק')|| ms.includes('ni gg')|| ms.includes('nagar')|| ms.includes('naygar')|| ms.includes('naagar'))
